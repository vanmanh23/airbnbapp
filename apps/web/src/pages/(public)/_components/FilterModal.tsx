...
export default function FilterModal() {
  const [tab, setTab] = useState('any type')
  ...
  return (
    <Dialog>
      ...
      <TabsList className="grid w-full grid-cols-2 h-16 border-solid border-2 border-gray-300" >
        <TabsTrigger value="account"  className="data-[state=active]:bg-black flex  items-center rounded-lg relative">Account</TabsTrigger>
        <TabsTrigger value="password" className="data-[state=active]:bg-black flex items-center">Password</TabsTrigger>
      </TabsList>
